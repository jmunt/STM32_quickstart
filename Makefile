...
ifeq ($(MCU), STM32F030x6)
	...
	ST_MCU_DEF = STM32F103xB
	MCU_CLASS = F1
else ifeq ($(MCU), STM32G030x6)
	MCU_FILES = STM32G030x6
	ST_MCU_DEF = STM32G030xx
	MCU_CLASS = G0
else ifeq ($(MCU), STM32G030x8)
	MCU_FILES = STM32G030x8
	ST_MCU_DEF = STM32G030xx
	MCU_CLASS = G0
else ifeq ($(MCU), STM32G031x4)
	MCU_FILES = STM32G031x4
	ST_MCU_DEF = STM32G031xx
	MCU_CLASS = G0
else ifeq ($(MCU), STM32G031x6)
	MCU_FILES = STM32G031x6
	ST_MCU_DEF = STM32G031xx
	MCU_CLASS = G0
else ifeq ($(MCU), STM32G031x8)
	MCU_FILES = STM32G031x8
	ST_MCU_DEF = STM32G031xx
	MCU_CLASS = G0
else ifeq ($(MCU), STM32G070xB)
	MCU_FILES = STM32G070xB
	ST_MCU_DEF = STM32G070xx
	MCU_CLASS = G0
else ifeq ($(MCU), STM32G071x8)
	MCU_FILES = STM32G071x8
	...
	MCU_CLASS = L0
else ifeq ($(MCU), STM32L072xZ)
	MCU_FILES = STM32L072xZ
	ST_MCU_DEF = STM32L072xx
	MCU_CLASS = L0	
